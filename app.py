...
<div class="main-header">
    ...
    <p>Tác giả: Phạm Thị Thúy Hằng - Trường Tiểu học Hùng An - ĐT: 0913236010</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Phạm Thị Thúy Hằng - Trường Tiểu học Hùng An- ĐT: 0913236010</div>", unsafe_allow_html=True)
